...
from graph.nodes import (
    plan_searches, execute_searches, analyse_sources,
    critique_findings, synthesize_report, should_loop_back
)
...
def build_research_graph() -> StateGraph:
    ...
    graph.add_node("analyze_sources", analyse_sources)
    ...
    graph.add_edge("execute_searches", "analyze_sources")
    graph.add_edge("analyze_sources", "critique_findings")
